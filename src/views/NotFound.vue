  ...
  <div class="h-screen w-screen bg-gray-100 flex items-center">
    ...
    >
      <div class="max-w-md">
        ...
        <a
          href="/"
          class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-cyan bg-cyan-600 active:bg-pink-600 hover:bg-pink-700"
        >
          back to homepage
        </a>
      </div>
